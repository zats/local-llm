            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        console.error('All permission checks failed:', e3);
    ...
    async checkContentScriptAndAPI() {
        try {
            ...
            try {
                ...
                console.error('Modern script execution failed, trying legacy method:', executeError);
                ...
                try {
                    ...
                    console.error('Legacy script execution also failed:', legacyError);
