...
EXTENSION_ID=$1
MANIFEST_PATH="native-app/com.nativefoundationmodels.native.json"
MANIFEST_PATH_INSTALLED="$HOME/Library/Application Support/Google/Chrome/NativeMessagingHosts/com.nativefoundationmodels.native.json"

echo "Updating native messaging manifest with extension ID: $EXTENSION_ID"

cp -f "$MANIFEST_PATH" "$MANIFEST_PATH_INSTALLED"
...
echo "3. Using the browser console to test the nativeFoundationModels API"